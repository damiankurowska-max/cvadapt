...
const DEMO_STEPS = [
  ...
  },
  {
    ...
    desc: "CVAdapt identifie les 18+ mots-clés ATS que les recruteurs attendent exactement.",
    screen: (
...
export function ModernLanding({ onNewsletter, emailStatus, email, setEmail, user = null }) {
  ...
  const circ = 2 * Math.PI * 54;
  const faqItems = [
    { q: "CVAdapt est-il vraiment gratuit ?", a: "Oui, 1 CV complet est généré gratuitement, sans carte bancaire requise." },
      ...
      <section className="cv-hero cv-section" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", alignItems: "center", gap: 48, maxWidth: 1200, margin: "0 auto", padding: "100px 40px 80px", position: "relative", minHeight: "100vh" }}>
        ...
        <div className="hero-left" style={{ display: "flex", flexDirection: "column", gap: 0, position: "relative", zIndex: 1 }}>
          ...
          <p className="cv-hero-p" style={{ fontSize: 17, color: C.slate, lineHeight: 1.7, marginBottom: 28, maxWidth: 480 }}>
            ...
            <strong style={{ color: C.navy }}>CVAdapt adapte ton CV aux filtres ATS en 30 secondes.</strong>
          </p>
      ...
      <footer style={{ borderTop: `1px solid ${C.border}`, background: C.bg }}>
        ...
        <div className="cv-footer-mobile">
          ...
          <div style={{ padding: "20px 20px 40px", background: C.bg }}>
            <p style={{ fontSize: 12, color: C.slateLight, marginBottom: 12 }}>© 2026 CVAdapt. Tous droits réservés.</p>
