...
const INJECTED_STYLES = `
  ...
  .btn-hero-primary:hover {
    ...
    box-shadow: 0 0 0 1px rgba(59,130,246,0.4), 0 8px 16px rgba(0,0,0,0.2), 0 24px 32px -6px rgba(29,78,216,0.7), inset 0 1px 1px rgba(255,255,255,0.3);
  }
  .btn-hero-primary:active { transform: translateY(1px); background: linear-gradient(180deg,#1D4ED8 0%,#1E40AF 100%); }
  ...
  .btn-hero-secondary:hover {
    ...
    box-shadow: 0 0 0 1px rgba(255,255,255,0.18), 0 8px 16px rgba(0,0,0,0.3), 0 24px 32px -6px rgba(0,0,0,0.8);
  }
  .btn-hero-secondary:active { transform: translateY(1px); }
  ...
  return (
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        <h2 className="text-4xl md:text-6xl lg:text-[5.5rem] font-bold mb-6 tracking-tight text-silver-matte">
          {ctaHeading}
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-5">
          <a
            href={primaryCtaHref}
            className="btn-hero-primary flex items-center justify-center px-8 py-4 rounded-[1.25rem] text-base font-bold focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-background"
          >
            {primaryCtaText}
          </a>
          <a
            href={secondaryCtaHref}
            className="btn-hero-secondary flex items-center justify-center px-8 py-4 rounded-[1.25rem] text-base font-semibold focus:outline-none focus:ring-2 focus:ring-white/30 focus:ring-offset-2 focus:ring-offset-background"
          >
            {secondaryCtaText}
          </a>
        </div>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="card-right-text gsap-reveal order-1 lg:order-3 flex justify-center lg:justify-end z-20 w-full">
              <h2 className="text-5xl md:text-[5.5rem] lg:text-[7rem] font-black uppercase tracking-tighter text-card-silver-matte leading-none">
                {brandName}
              </h2>
            </div>

            {/* CENTER — Phone mockup with 3D parallax */}
            <div
              className="mockup-scroll-wrapper order-2 relative w-full h-[360px] lg:h-[600px] flex items-center justify-center z-10"
            ...
            >
              <div className="relative w-full h-full flex items-center justify-center scale-[0.65] md:scale-[0.85] lg:scale-100">
                  ...
                  <div className="absolute inset-[7px] bg-[#030B1A] rounded-[2.5rem] overflow-hidden text-white z-10">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      ...
                      <div className="phone-widget flex justify-between items-center mb-7">
                        ...
                        <div className="w-9 h-9 rounded-full bg-blue-600/20 text-blue-300 flex items-center justify-center text-xs font-bold border border-blue-500/20">
                          IA
                        </div>
                      </div>

                      {/* ATS Score ring */}
                      <div className="phone-widget relative w-44 h-44 mx-auto flex items-center justify-center mb-7 drop-shadow-[0_15px_25px_rgba(0,0,0,0.8)]">
                        ...
                        <div className="text-center z-10 flex flex-col items-center">
                          <span className="counter-val text-5xl font-extrabold tracking-tighter text-white tabular-nums">0</span>
                      ...
                      <div className="space-y-3">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="h-1.5 w-14 bg-neutral-600 rounded-full" />
                          </div>
                        ...
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="h-2 w-24 bg-neutral-200 rounded-full mb-2" />
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-blue-500/20 to-blue-900/10 flex items-center justify-center border border-blue-400/30 flex-shrink-0">
                    <span className="text-base lg:text-xl" aria-hidden="true">🎯</span>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight whitespace-nowrap">{badge1Label}</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs whitespace-nowrap">{badge1Sub}</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-emerald-500/20 to-emerald-900/10 flex items-center justify-center border border-emerald-400/30 flex-shrink-0">
                    <span className="text-base lg:text-lg" aria-hidden="true">⚡</span>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight whitespace-nowrap">{badge2Label}</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs whitespace-nowrap">{badge2Sub}</p>
                  </div>
                </div>
            ...
            <div className="card-left-text gsap-reveal order-3 lg:order-1 flex flex-col justify-center text-center lg:text-left z-20 w-full px-4 lg:px-0">
              ...
              <p className="hidden md:block text-blue-100/70 text-sm md:text-base lg:text-lg font-normal leading-relaxed max-w-sm lg:max-w-none mx-auto lg:mx-0">
                {cardDescription}
              </p>
            </div>
