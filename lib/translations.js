...
export const translations = {
  fr: {
    ...
    hero: {
      ...
      subtitle: "75% des CV sont rejetés par les ATS avant d'être lus par un humain. Postulera analyse l'offre, optimise ton CV et le rend indétectable aux filtres.",
      cta: "Générer mon CV gratuitement →",
      ctaSub: "1 CV gratuit · Aucune CB requise",
    },
    stats: {
    ...
    features: {
      ...
      cv: {
        ...
        desc: "Postulera réécrit ton CV pour matcher l'offre avec les mots-clés exacts.",
      },
      lm: {
    ...
    pricing: {
      ...
      free: {
        ...
        features: ["1 CV complet", "Score ATS basique", "Export PDF"],
    ...
    faq: {
      ...
      items: [
        { q: "C'est vraiment gratuit pour commencer ?", a: "Oui. Tu génères 1 CV complet gratuitement, sans carte bancaire. Le plan Étudiant à 4,99€/mois débloque 15 CV par mois avec score ATS et lettre de motivation." },
        { q: "Ça marche sans expérience professionnelle ?", a: "Oui, c'est fait pour ça. Postulera met en avant tes projets universitaires, stages, associations et compétences dans le format que les recruteurs attendent." },
        { q: "Postulera fonctionne pour les stages et alternances ?", a: "Oui — c'est même son point fort. Il analyse l'offre de stage ou d'alternance et adapte ton CV aux mots-clés exacts de chaque entreprise." },
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: "75% of CVs are rejected by ATS filters before a human ever reads them. Postulera analyzes the job posting, optimizes your CV and makes it ATS-proof.",
    ...
    features: {
      ...
      cv: {
        ...
        desc: "Postulera rewrites your CV to match the job with the exact right keywords.",
      },
      lm: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Does it work without professional experience?", a: "Yes, it's designed for that. Postulera highlights your university projects, internships, and skills in the format recruiters expect." },
        { q: "Does Postulera work for internships?", a: "Yes — that's actually its strongest point. It analyzes the internship posting and tailors your CV to the exact keywords each company is looking for." },
