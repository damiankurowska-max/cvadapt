/**
 * Templates HTML pour les emails Postulera
      ...
      <tr><td align="center">
        <table width="100%" style="max-width:560px;" cellpadding="0" cellspacing="0">
          ...
          <tr><td style="padding-bottom:24px;text-align:center;">
            <img src="https://postulera.com/logo-256.png" width="44" height="44"
              alt="Postulera" style="border-radius:10px;display:inline-block;vertical-align:middle;margin-right:10px;" />
            <span style="font-size:20px;font-weight:800;color:#2563eb;vertical-align:middle;letter-spacing:-0.5px;">Postulera</span>
          </td></tr>
          ...
          <tr><td style="padding-top:24px;text-align:center;">
            <p style="font-size:12px;color:#9ca3af;margin:0 0 8px;">
              Postulera · <a href="https://postulera.com" style="color:#9ca3af;">postulera.com</a> ·
              <a href="mailto:contact@postulera.com" style="color:#9ca3af;">contact@postulera.com</a>
            </p>
            <p style="font-size:11px;color:#d1d5db;margin:0 0 6px;">© ${new Date().getFullYear()} Postulera — Fait en France 🇫🇷</p>
            <p style="font-size:11px;color:#d1d5db;margin:0;">
              <a href="mailto:contact@postulera.com?subject=unsubscribe" style="color:#d1d5db;text-decoration:underline;">Se désinscrire</a>
            </p>
          </td></tr>
  ...
  const content = `
    ...
    <tr><td style="background:linear-gradient(135deg,#1e40af,#2563eb);padding:36px 40px 32px;text-align:center;">
      ...
      <h1 style="margin:0;font-size:24px;font-weight:800;color:#ffffff;line-height:1.2;">
        Bienvenue dans la liste Postulera !
      </h1>
    ...
    <tr><td style="padding:32px 40px;">
      ...
      ${btn("Analyser mon CV gratuitement →", "https://postulera.com/analyse")}
    </td></tr>
...
export function paymentConfirmationEmail({ plan, email }) {
  ...
  const content = `
    ...
    <tr><td style="padding:24px 40px;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0">
        ${[
          ["⚡", "Générer ton prochain CV", "https://postulera.com/generate"],
          ["🎯", "Analyser ton CV existant", "https://postulera.com/analyse"],
          ["📊", "Voir ton dashboard", "https://postulera.com/dashboard"],
        ].map(([icon, label, href]) => `
          <tr><td style="padding:8px 0;border-bottom:1px solid #f3f4f6;">
      ...
      ${btn("Générer mon CV maintenant →", "https://postulera.com/generate")}
    </td></tr>
    ...
    <tr><td style="background:#f9fafb;border-top:1px solid #f3f4f6;padding:20px 40px;text-align:center;border-radius:0 0 20px 20px;">
      <p style="margin:0;font-size:12px;color:#9ca3af;">
        ...
        <a href="mailto:contact@postulera.com" style="color:#2563eb;">contact@postulera.com</a>
      </p>
    </td></tr>
  `;
  return wrapper(`<table width="100%" cellpadding="0" cellspacing="0">${content}</table>`);
...
export function noCvReminderEmail({ prenom }) {
  const content = `
    ...
    <tr><td style="padding:32px 40px 0;">
      ...
      ${btn("Générer mon premier CV →", "https://postulera.com/generate")}

      <p style="margin:20px 0 32px;font-size:12px;color:#9ca3af;text-align:center;">
        Gratuit · Sans carte bancaire · 1 CV gratuit
      </p>
    ...
    <tr><td style="padding:20px 40px 28px;">
      <p style="margin:0;font-size:13px;color:#6b7280;line-height:1.7;font-style:italic;">
        "J'ai construit Postulera pour les gens qui cherchent sans réseau.
...
// ══════════════════════════════════════════════════════════════
// 3. EMAIL RELANCE — LIMITE 1 CV ATTEINTE
// ══════════════════════════════════════════════════════════════
export function upgradeReminderEmail({ prenom }) {
  const content = `
    <!-- Header navy -->
    <tr><td style="background:#0f172a;padding:36px 40px 32px;text-align:center;">
      <p style="margin:0 0 16px;font-size:13px;font-weight:600;color:#64748b;letter-spacing:1.5px;text-transform:uppercase;">Postulera</p>
      <h1 style="margin:0;font-size:22px;font-weight:800;color:#f8fafc;line-height:1.3;">
        ${prenom ? `${prenom}, tu` : "Tu"} as généré ton CV gratuit.<br>Le filtre n'a plus le même pouvoir.
      </h1>
    </td></tr>
    ...
    <tr><td style="padding:32px 40px 0;">
      ...
      <p style="margin:0 0 28px;font-size:15px;color:#374151;line-height:1.75;">
        Avec Postulera, tu es passé de l'autre côté. Tu sais comment ça fonctionne, et tu l'utilises.
      ...
      ${btn("Continuer — Plan Étudiant 4,99€/mois", "https://postulera.com/tarifs")}
    ...
    <tr><td style="padding:20px 40px 28px;">
      <p style="margin:0;font-size:13px;color:#6b7280;line-height:1.7;font-style:italic;">
        "J'ai construit Postulera parce que j'ai cherché un emploi sans réseau, en envoyant des CV dans le vide.
  ...
  const content = `
    ...
    <tr><td style="padding:32px 40px;">
      ...
      <p style="margin:0 0 16px;font-size:15px;color:#374151;line-height:1.7;">
        ...
        C'est exactement ce que Postulera fait en 30 secondes.
      </p>

      ${btn("Optimiser mon CV maintenant →", "https://postulera.com/generate", "#4f46e5")}
    </td></tr>
    ...
    <tr><td style="background:#f9fafb;border-top:1px solid #f3f4f6;padding:16px 40px;text-align:center;border-radius:0 0 20px 20px;">
      <p style="margin:0;font-size:12px;color:#9ca3af;">
        Tu reçois cet email car tu t'es inscrit(e) sur Postulera.
        <a href="mailto:contact@postulera.com?subject=STOP" style="color:#9ca3af;">Se désinscrire</a>
      </p>
    </td></tr>
  `;
  return wrapper(`<table width="100%" cellpadding="0" cellspacing="0">${content}</table>`);
...
export function testimonialEmail({ prenom }) {
  const content = `
    ...
    <tr><td style="padding:32px 40px;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr><td style="padding:20px 24px;">
          <p style="margin:0 0 12px;font-size:15px;color:#374151;line-height:1.7;font-style:italic;">
            "Mon profil était générique. Zéro réponse pendant 3 semaines. J'ai utilisé Postulera
      ...
      <p style="margin:0 0 20px;font-size:15px;color:#374151;line-height:1.7;">
        Théo n'est pas une exception. Chaque jour, des étudiants utilisent Postulera pour transformer
        leur candidature en 30 secondes. <strong>Tu es à 30 secondes de ton premier entretien.</strong>
      </p>

      ${btn("Générer mon CV optimisé →", "https://postulera.com/generate", "#059669")}
    </td></tr>
  ...
  const content = `
    <tr><td style="padding:40px 40px 32px;">
      ...
      <p style="margin:0 0 28px;font-size:15px;color:#6b7280;text-align:center;line-height:1.6;">
        Pendant cette semaine, ${Math.floor(Math.random() * 300 + 800)} étudiants ont décroché des entretiens grâce à Postulera.
      </p>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:16px;margin-bottom:28px;">
        <tr><td style="padding:20px 24px;text-align:center;">
          ...
          <p style="margin:0 0 8px;font-size:32px;font-weight:800;color:#2563eb;">1 CV gratuit</p>
          <p style="margin:0;font-size:13px;color:#6b7280;">Sans carte bancaire · Résultat en 30 secondes</p>
        </td></tr>
      </table>

      ${btn("Reprendre maintenant →", "https://postulera.com/generate")}
  ...
  const content = `
    ...
    <tr><td style="padding:32px 40px;">
      ...
      <p style="margin:0 0 24px;font-size:15px;color:#374151;line-height:1.7;">
        Postulera analyse l'offre d'emploi et intègre exactement les mots-clés attendus dans ton CV. <strong>Résultat : ton CV passe les filtres et atterrit sur le bureau du recruteur.</strong>
      </p>

      ${btn("Tester mon score ATS gratuitement →", "https://postulera.com/analyse", "#dc2626")}
    </td></tr>
...
export function j5Email({ prenom }) {
  const content = `
    ...
    <tr><td style="padding:32px 40px;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr><td style="padding:20px 24px;">
          ...
          <p style="margin:0;font-size:14px;color:#374151;line-height:1.7;font-style:italic;">
            ...
            Postulera a mis en avant mes projets universitaires exactement comme les recruteurs les cherchent.
      ...
      ${[
        ["📋", "Elle a collé l'offre de stage dans Postulera"],
        ["✍️", "Elle a ajouté ses projets et compétences"],
        ["🚀", "Postulera a généré un CV optimisé en 30 secondes"],
      ...
      ${btn("Générer mon CV comme Emma →", "https://postulera.com/generate", "#7c3aed")}
    </td></tr>
...
export function j7Email({ prenom }) {
  const content = `
    ...
    <tr><td style="padding:32px 40px;">
      ...
      <p style="margin:0 0 24px;font-size:15px;color:#374151;line-height:1.7;">
        Voici ce qu'on observe chez les utilisateurs Postulera cette semaine :
      </p>
      ...
      ${btn("Voir mon score ATS →", "https://postulera.com/analyse", "#059669")}
    </td></tr>
...
export function j14Email({ prenom }) {
  const content = `
    ...
    <tr><td style="padding:32px 40px;">
      ...
      <p style="margin:0 0 20px;font-size:15px;color:#374151;line-height:1.7;">
        Ça fait 2 semaines que tu as créé ton compte sur Postulera. Si tu cherches encore
      ...
      ${btn("Activer mon -20% →", "https://postulera.com/tarifs?promo=CV20", "#d97706")}
...
// ══════════════════════════════════════════════════════════════
export function j3SurveyEmail({ prenom, baseUrl = "https://postulera.com" }) {
  ...
  const content = `
    ...
    <tr><td style="background:linear-gradient(135deg,#064e3b,#059669);padding:36px 40px 32px;text-align:center;">
      ...
      <p style="margin:10px 0 0;font-size:14px;color:#a7f3d0;">
        Aide-nous à améliorer Postulera pour toi
      </p>
    </td></tr>
    ...
    <tr><td style="padding:32px 40px;">
      <p style="margin:0 0 24px;font-size:15px;color:#374151;line-height:1.7;">
        ...
        3 questions rapides sur ta recherche d'emploi — tes réponses nous aident à rendre Postulera vraiment utile. En échange, <strong>3 CV supplémentaires</strong> sont ajoutés à ton compte.
      </p>
      ...
      <div style="background:#f9fafb;border-radius:14px;padding:20px 24px;margin-bottom:28px;">
        <p style="margin:0 0 12px;font-size:14px;font-weight:700;color:#111827;">
          3️⃣ Tu as découvert Postulera comment ?
        </p>
        <div style="text-align:center;">
    ...
    <tr><td style="padding:32px 40px;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr>
          ...
          <td style="padding:20px;text-align:center;">
            ...
            <p style="margin:4px 0 0;font-size:12px;color:#6b7280;">Après Postulera</p>
          </td>
        </tr>
      </table>

      <p style="margin:0 0 20px;font-size:15px;color:#374151;line-height:1.7;">
        Postulera analyse l'offre d'emploi et intègre automatiquement les mots-clés attendus dans ton CV.
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
        ${[
          ...
          ["🚀", "Postulera génère ton CV optimisé en 30 secondes"],
      ...
      ${btn("Générer mon CV maintenant — C'est gratuit →", "https://postulera.com/generate")}
    </td></tr>
      ...
      <tr><td align="center">
        <table width="100%" style="max-width:560px;" cellpadding="0" cellspacing="0">
          ...
          <tr><td style="padding-top:24px;text-align:center;">
            ...
            <p style="font-size:11px;color:#d1d5db;margin:0 0 6px;">© ${new Date().getFullYear()} Postulera</p>
            <p style="font-size:11px;color:#d1d5db;margin:0;">
              <a href="mailto:contact@postulera.com?subject=unsubscribe" style="color:#d1d5db;text-decoration:underline;">Unsubscribe</a>
            </p>
          </td></tr>
...
export function welcomeNewsletterEmailEN() {
  const content = `
    ...
    <tr><td style="padding:32px 40px;">
      ...
      ${btn("Analyze my resume for free →", "https://postulera.com/analyse")}
    </td></tr>
    ...
    <tr><td style="padding:32px 40px;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr>
          ...
          <td style="padding:20px;text-align:center;">
            <p style="margin:0;font-size:32px;font-weight:800;color:#059669;">91</p>
            <p style="margin:4px 0 0;font-size:12px;color:#6b7280;">After Postulera</p>
          </td>
        </tr>
      </table>

      <p style="margin:0 0 20px;font-size:15px;color:#374151;line-height:1.7;">
        Postulera reads the job posting and automatically weaves in the right keywords.
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
        ${[
          ...
          ["🚀", "Postulera generates your optimized resume in 30 seconds"],
      ...
      ${btn("Generate my resume now — It's free →", "https://postulera.com/generate")}
    </td></tr>

    <tr><td style="background:#f9fafb;border-top:1px solid #f3f4f6;padding:20px 40px;text-align:center;border-radius:0 0 20px 20px;">
      <p style="margin:0;font-size:12px;color:#9ca3af;">
        You're receiving this because you signed up on Postulera.
        <a href="mailto:contact@postulera.com?subject=unsubscribe" style="color:#9ca3af;">Unsubscribe</a>
      </p>
    </td></tr>
  `;
  return wrapperEN(`<table width="100%" cellpadding="0" cellspacing="0">${content}</table>`);
  ...
  const content = `
    ...
    <tr><td style="padding:32px 40px;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr><td style="padding:28px 28px;">
          <p style="margin:0 0 16px;font-size:16px;color:#0f172a;line-height:1.7;font-style:italic;">
            ...
            I tried Postulera for one posting, adapted my resume in 30 seconds,
      ...
      <p style="margin:0 0 28px;font-size:15px;color:#374151;line-height:1.7;">
        If you haven't tried Postulera yet, here's your chance. 3 resumes free, no credit card.
      </p>

      ${btn("Generate my tailored resume →", "https://postulera.com/generate")}
    </td></tr>
...
export function j7EmailEN({ prenom }) {
  const content = `
    <tr><td style="background:linear-gradient(135deg,#065f46,#059669);padding:36px 40px 32px;text-align:center;">
      <div style="font-size:40px;margin-bottom:12px;">📊</div>
      <h1 style="margin:0;font-size:24px;font-weight:800;color:#ffffff;line-height:1.2;">
        ${prenom ? `${prenom}, here's` : "Here's"} why 85% of Postulera resumes pass ATS
      </h1>
      <p style="margin:10px 0 0;font-size:15px;color:#a7f3d0;">
    ...
    <tr><td style="padding:32px 40px;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0"
        ...
        ${[
          ["85%", "of Postulera resumes pass ATS filters"],
      ...
      <p style="margin:0 0 28px;font-size:15px;color:#374151;line-height:1.7;">
        6 seconds. That's it. Your resume needs to make an instant impact — with the exact keywords the recruiter searched for. Postulera does this automatically.
      </p>

      ${btn("Check my ATS score — Free →", "https://postulera.com/analyse")}
    </td></tr>
...
export function j14EmailEN({ prenom }) {
  const content = `
    ...
    <tr><td style="padding:32px 40px;">
      ...
      <p style="margin:0 0 20px;font-size:15px;color:#374151;line-height:1.7;">
        You've been with Postulera for 2 weeks. To help you land your next interview, here's a <strong>20% discount on any plan</strong>.
      </p>
      ...
      ${btn("Unlock unlimited resumes →", "https://postulera.com/tarifs?promo=CV20", "#d97706")}
    </td></tr>
...
export function ownerNotificationEmail({ type, data }) {
  ...
  const content = `
    <tr><td style="padding:32px 40px;">
      <h2 style="margin:0 0 20px;font-size:20px;font-weight:800;color:#111827;">${titles[type] || "📢 Notification Postulera"}</h2>
