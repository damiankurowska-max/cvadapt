...
const config = {
  hero: {
    ...
    subtitle: "Recrutement, GPEC, formation, paie, HRBP, relations sociales... Postulera intègre les logiciels SIRH (Workday, SuccessFactors, SILAE) et les termes exacts attendus par les recruteurs.",
    stats: [
  ...
  steps: [
    { title: "Colle l'offre RH", desc: "Postulera analyse les missions, SIRH et compétences attendus dans l'offre." },
  ...
  examples: {
    title: "Des profils RH qui ont décroché leur poste avec Postulera",
    subtitle: "Chargé RH, recruteur, HRBP, responsable formation.",
    items: [
      { emoji: "👥", name: "Laura D.", role: "Chargée RH · Lille", text: "En tant que RH je sais ce que les recruteurs cherchent. Postulera coche toutes les cases — mêmes mots-clés, même structure.", result: "Poste décroché en 1 semaine" },
      { emoji: "🔍", name: "Céline V.", role: "Recruteuse → HRBP · Rennes", text: "Postulera a traduit mon profil de recruteur vers HRBP parfaitement. Les missions et les compétences correspondaient exactement.", result: "Évolution HRBP réussie" },
      { emoji: "📋", name: "Nathalie D.", role: "Responsable formation · Bordeaux", text: "Mon CV mentionnait les mêmes compétences mais pas avec les bons termes. Postulera a tout aligné. Rappelée en 4 jours.", result: "CDI responsable formation" },
      { emoji: "💼", name: "Isabelle R.", role: "DRH · Grande enseigne · Nice", text: "Même à un niveau DRH, Postulera permet d'aligner précisément son profil sur chaque offre. Très efficace.", result: "Poste DRH signé" },
    ],
  },
  faq: [
    { q: "Postulera reconnaît les SIRH ?", a: "Oui — Workday, SuccessFactors, SAP HR, SILAE, Lucca, Cegid, ADP, Talentsoft... Postulera détecte ceux mentionnés dans l'offre et les intègre si tu les maîtrises." },
