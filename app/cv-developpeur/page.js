...
const config = {
  hero: {
    ...
    subtitle: "Les offres dev sont ultra-précises sur les technos. Postulera analyse l'offre et intègre exactement le bon stack, les bons frameworks et les bons mots-clés ATS — React, Node, Python, AWS...",
    stats: [
      { value: "85%", label: "des offres dev utilisent des ATS" },
      { value: "30 sec", label: "pour adapter ton CV" },
      { value: "Score 94", label: "ATS moyen après Postulera" },
    ],
  },
  steps: [
    { title: "Colle l'offre dev", desc: "LinkedIn, Welcome to the Jungle, Indeed, Stack Overflow Jobs... Postulera détecte le stack et les technos attendus." },
  ...
  examples: {
    title: "Des devs qui ont booké des entretiens avec Postulera",
    ...
    items: [
      ...
      { emoji: "☁️", name: "Youssef K.", role: "DevOps · Lyon", text: "Postulera a détecté que je n'utilisais pas les bons termes AWS/Terraform. Optimisé en 30 secondes, offre reçue avec +20% de salaire.", result: "Offre +20% salaire" },
      { emoji: "📱", name: "Samuel O.", role: "Dev mobile · Montpellier", text: "Postulera m'a aidé à adapter mon CV pour des offres React Native internationales en remote. Objectif atteint.", result: "Remote job obtenu" },
    ],
  },
  faq: [
    { q: "Pourquoi mon CV dev est rejeté malgré mes compétences ?", a: "Souvent parce que les mots-clés ne correspondent pas exactement à ceux de l'offre. Un recruteur cherche 'React' mais ton CV dit 'ReactJS' ou 'React.js'. Postulera harmonise automatiquement." },
