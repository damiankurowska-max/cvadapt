...
export const metadata = {
  title: "CV Sans Expérience Professionnelle — Modèle Étudiant | Postulera",
  description: "Crée un CV convaincant même sans expérience professionnelle. Postulera valorise ta formation, tes projets et tes compétences pour décrocher ton premier stage ou alternance.",
    ...
    <main className="min-h-screen" style={{ background: "#f0f7ff", fontFamily: "var(--font-outfit,'Outfit',system-ui,sans-serif)" }}>
      ...
      <section className="max-w-4xl mx-auto px-5 pt-16 pb-12 text-center">
        ...
        <p className="max-w-2xl mx-auto mb-8 text-lg" style={{ color: "#4b5563" }}>
          Pas d'expérience ? Pas de problème. Postulera valorise ta formation, tes projets universitaires 
      ...
      <section className="py-16 px-5 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-4" style={{ color: "#1e3a8a" }}>
            Ce que Postulera met en avant à ta place
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {[
              ...
              { icon:"📈", t:"Réalisations chiffrées", d:"Postulera transforme tes activités en résultats mesurables (x membres gérés, x projet livré...)." },
