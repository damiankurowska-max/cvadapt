...
export const metadata = {
  title: "CV Logistique Gratuit — Optimisé ATS en 30 secondes | Postulera",
  description: "Génère un CV logistique adapté à chaque offre. Postulera intègre les mots-clés ATS supply chain, transport et entrepôt en 30 secondes. Gratuit, sans CB.",
  keywords: "cv logistique gratuit, modèle cv logistique, cv supply chain, cv responsable logistique, cv coordinateur logistique",
  alternates: { canonical: "https://postulera.com/cv-logistique" },
};

const ERREURS = [
  { titre: "Logiciels WMS et ERP absents", solution: "SAP, WMS, Oracle, Sage — Postulera les intègre selon ce que l'offre exige" },
  { titre: "Indicateurs de performance manquants", solution: "Postulera structure tes KPIs : taux de service, délais, taux de rupture, coûts" },
  { titre: "Certifications et CACES non valorisés", solution: "Postulera met en avant tes habilitations et certifications au bon endroit du CV" },
  { titre: "Secteur non ciblé", solution: "Postulera adapte le vocabulaire : e-commerce, industrie, grande distribution, transport" },
];

const TEMOIGNAGES = [
  { nom: "Marc D.", poste: "Responsable logistique · Marseille", resultat: "CDI Amazon décroché", texte: "Mon CV ne mentionnait pas les bons logiciels WMS. Postulera a tout corrigé et adapté à l'offre Amazon en 30 secondes." },
  { nom: "Sophie L.", poste: "Coordinatrice supply chain · Lyon", resultat: "Rappelée en 48h", texte: "J'avais du mal à valoriser mes KPIs logistiques. Postulera les a structurés exactement comme le recruteur s'y attendait." },
    ...
    <main className="min-h-screen" style={{ background: "#f0f7ff", fontFamily: "var(--font-outfit,'Outfit',system-ui,sans-serif)" }}>
      ...
      <section className="max-w-4xl mx-auto px-5 pt-16 pb-12 text-center">
        ...
        <p className="max-w-2xl mx-auto mb-8 text-lg" style={{ color: "#4b5563" }}>
          ...
          Postulera intègre les mots-clés exacts — WMS, ERP, CACES, KPIs — pour que ton CV passe les filtres.
        </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
            {[
              ...
              { n:"2", e:"🚛", t:"Tes compétences", d:"Logiciels, CACES, KPIs, secteurs. Postulera structure ton profil logistique." },
              { n:"3", e:"🚀", t:"CV prêt", d:"Postulera génère un CV avec les mots-clés supply chain exacts. Score ATS inclus." },
            ].map(s => (
      ...
      <section className="py-16 px-5" style={{ background: "#ffffff" }}>
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-10" style={{ color: "#1e3a8a" }}>
            Ils ont décroché leur poste en logistique avec Postulera
          </h2>
