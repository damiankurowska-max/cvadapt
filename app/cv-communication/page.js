...
export const metadata = {
  title: "CV Communication Gratuit — Optimisé ATS en 30 secondes | Postulera",
  description: "Génère un CV communication adapté à chaque offre. Postulera intègre les mots-clés ATS en 30 secondes. Chargé de communication, community manager, attaché de presse.",
  ...
  alternates: { canonical: "https://postulera.com/cv-communication" },
};

const ERREURS = [
  { titre: "Portfolio et réseaux absents du CV", solution: "Postulera intègre tes liens portfolio, réseaux gérés et métriques d'engagement" },
  { titre: "Outils digitaux non mentionnés", solution: "Canva, Adobe, Hootsuite, Mailchimp, WordPress — Postulera les ajoute selon l'offre" },
  { titre: "Résultats de campagnes non chiffrés", solution: "Postulera structure tes résultats : reach, taux d'engagement, croissance followers" },
  { titre: "Spécialité non ciblée", solution: "Postulera adapte le CV selon ta spécialité : digital, interne, institutionnelle, événementiel" },
];

const TEMOIGNAGES = [
  { nom: "Chloé R.", poste: "Chargée de communication · Paris", resultat: "CDI chez LVMH en 3 semaines", texte: "Mon CV ne mettait pas en avant mes métriques Instagram. Postulera les a intégrées avec les bons mots-clés en 30 secondes." },
  { nom: "Baptiste F.", poste: "Community Manager · Lyon", resultat: "3 entretiens la première semaine", texte: "J'avais un bon portfolio mais un mauvais CV. Postulera a fait le lien entre mes réalisations et ce que cherchaient les ATS." },
  { nom: "Léa M.", poste: "Attachée de presse · Bordeaux", resultat: "Recrutée en agence RP", texte: "Postulera a reformulé mes expériences avec le vocabulaire exact du secteur RP. Rappelée en 48h." },
];
    ...
    <main className="min-h-screen" style={{ background: "#f0f7ff", fontFamily: "var(--font-outfit,'Outfit',system-ui,sans-serif)" }}>
      ...
      <section className="max-w-4xl mx-auto px-5 pt-16 pb-12 text-center">
        ...
        <p className="max-w-2xl mx-auto mb-8 text-lg" style={{ color: "#4b5563" }}>
          ...
          Postulera adapte ton CV aux mots-clés exacts : digital, RP, événementiel, brand content.
        </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
            {[
              ...
              { n:"2", e:"📣", t:"Tes réalisations", d:"Campagnes, métriques, outils, portfolio. Postulera chiffre tes résultats." },
              { n:"3", e:"🚀", t:"CV prêt", d:"Postulera génère un CV avec les mots-clés communication exacts. Score ATS inclus." },
            ].map(s => (
      ...
      <section className="py-16 px-5" style={{ background: "#ffffff" }}>
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-10" style={{ color: "#1e3a8a" }}>
            Ils ont décroché leur poste en communication avec Postulera
          </h2>
