        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              { q:"CVAdapt est-il vraiment gratuit ?", r:"Oui. Tu génères 1 CV complet gratuitement, sans carte bancaire. Le plan Étudiant à 4,99€/mois débloque 15 CV par mois avec score ATS et lettre de motivation." },
            ].map((item, i) => (
