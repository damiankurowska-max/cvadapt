...
const config = {
  hero: {
    ...
    subtitle: "Comptabilité générale, contrôle de gestion, audit, trésorerie... Postulera intègre les logiciels (SAP, Sage, Cegid) et les normes (IFRS, PCG) que les recruteurs finance exigent.",
    stats: [
      { value: "90%", label: "des cabinets utilisent des ATS" },
      { value: "30 sec", label: "pour adapter ton CV" },
      { value: "Score 91", label: "ATS moyen après Postulera" },
    ],
  },
  steps: [
    { title: "Colle l'offre finance/compta", desc: "Cabinet, entreprise, BIG 4... Postulera détecte les logiciels et normes attendus." },
  ...
  examples: {
    ...
    items: [
      { emoji: "📒", name: "Julien F.", role: "Comptable général · Marseille", text: "Postulera a ajouté SAP et les normes IFRS que l'offre demandait. CDI signé en 3 semaines.", result: "CDI signé" },
      { emoji: "📈", name: "Marie-Claire B.", role: "Contrôleur de gestion · Paris", text: "Le recruteur a dit que mon CV était parfaitement aligné sur le poste. Postulera a fait la différence.", result: "4 entretiens en 2 semaines" },
      { emoji: "🔎", name: "Antoine P.", role: "Auditeur junior · Lyon", text: "Mon score ATS est passé de 41 à 94. Les termes d'audit manquaient — Postulera les a ajoutés automatiquement.", result: "Score ATS 41→94" },
      { emoji: "💼", name: "Clara N.", role: "DAF · PME tech · Paris", text: "Même en profil senior, Postulera aligne le vocabulaire exactement sur chaque offre. Gain de temps énorme.", result: "Poste DAF décroché" },
    ],
  },
  faq: [
    { q: "Postulera reconnaît les logiciels comptables ?", a: "Oui — SAP, Sage (50/100/1000), Cegid, Quadratus, Divalto, Excel avancé, Power BI... Postulera détecte ceux mentionnés dans l'offre et les intègre si tu les maîtrises." },
