...
const config = {
  hero: {
    ...
    subtitle: "Community manager, chef de projet digital, chargé de communication... Postulera intègre exactement les outils, KPIs et mots-clés que les recruteurs marketing cherchent.",
    stats: [
  ...
  steps: [
    { title: "Colle l'offre marketing", desc: "LinkedIn, Welcome to the Jungle, Cadremploi... Postulera détecte les outils et KPIs attendus." },
  ...
  examples: {
    ...
    items: [
      { emoji: "📱", name: "Pauline M.", role: "Community Manager · Bordeaux", text: "Postulera a ajouté exactement les bons KPIs et outils de l'offre. Une agence parisienne m'a contactée directement.", result: "CDI agence parisienne" },
      { emoji: "📊", name: "Anaïs G.", role: "Responsable marketing · Paris", text: "Mon taux de réponse a triplé depuis que j'utilise Postulera pour chaque candidature. Les recruteurs notent la précision.", result: "Taux de réponse ×3" },
      { emoji: "🔍", name: "Lucie H.", role: "Chargée SEO/Content · Lyon", text: "Postulera a reformulé mes missions avec les bons termes SEO/SEM de l'offre. Entretien décroché en 3 jours.", result: "Entretien J+3" },
      { emoji: "🎯", name: "Clara N.", role: "Brand Manager · Paris", text: "Les recruteurs en marketing sont très exigeants sur le vocabulaire. Postulera aligne parfaitement mon CV à chaque offre.", result: "Poste brand manager" },
    ],
  },
  faq: [
    { q: "Quels outils marketing Postulera reconnaît-il ?", a: "Meta Ads, Google Ads, HubSpot, Salesforce, Mailchimp, SEMrush, GA4, Canva, Adobe Suite, Hootsuite... Postulera reconnaît les principaux outils du secteur et les intègre si l'offre les mentionne." },
