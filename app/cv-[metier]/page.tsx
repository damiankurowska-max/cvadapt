...
// Next.js 16 — App Router dynamic SEO page for Postulera
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `https://postulera.com/cv-${m.slug}` },
    openGraph: {
      title: m.titleSeo,
      description: m.metaDescription,
    ...
    "@graph": [
      {
        ...
        publisher: { "@type": "Organization", name: "Postulera", logo: { "@type": "ImageObject", url: "https://postulera.com/logo.png" } },
      ...
      <article className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="rounded-2xl bg-emerald-50 border border-emerald-200 p-6 mb-10">
          ...
          <p className="text-slate-700 mb-4">
            Postulera analyse l'offre d'emploi et adapte automatiquement ton CV avec les bons mots-clés ATS pour le poste de {m.metier}.
          </p>
